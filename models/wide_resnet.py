...
class WideResNet28x10(WideResNet):
  def __init__(self,
               ...
               norm_args: Optional[Dict[str, Any]] = None,
               name: Optional[str] = None):
    super(WideResNet28x10, self).__init__(num_classes, 28, 10, activation, norm_args, name)
...
class WideResNet16x4(WideResNet):
  def __init__(self,
               ...
               norm_args: Optional[Dict[str, Any]] = None,
               name: Optional[str] = None):
    super(WideResNet16x4, self).__init__(num_classes, 16, 4, activation, norm_args, name)
...
class WideResNet22x4(WideResNet):
  def __init__(self,
               ...
               norm_args: Optional[Dict[str, Any]] = None,
               name: Optional[str] = None):
    super(WideResNet28x10, self).__init__(num_classes, 22, 4, activation, norm_args, name)
...
class WideResNet16x8(WideResNet):
  def __init__(self,
               ...
               norm_args: Optional[Dict[str, Any]] = None,
               name: Optional[str] = None):
    super(WideResNet16x8, self).__init__(num_classes, 16, 8, activation, norm_args, name)