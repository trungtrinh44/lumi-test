...
import models
import argparse
from datasets import CIFAR10_1
import optax
...
if __name__ == '__main__':
    ...
    os.makedirs(os.path.join(args.root, 'cifar10_1'), exist_ok=True)
    dataloader = torch.utils.data.DataLoader(
        CIFAR10_1(os.path.join('data', 'CIFAR-10-1'), transform),
    ...
    with open(os.path.join(args.root, 'cifar10_1', 'result.json'), 'w') as out:
